...
const RouteFilter = ({ selectedRoute, setSelectedRoute }: {
  ...
  const { data: routes, loading } = useGet<ListWrapper<TypeWrapper<Route>[]>>(`${BASE_URL}/routes?${encodeURI(pageParams)}`, { isArray: true })
  ...
  return (
    <div className='flex flex-wrap gap-2 items-center'>
      ...
      {loading ? (
        <div className='bg-gray-200 rounded-lg p-2 w-20 h-9 flex justify-center items-center'>
