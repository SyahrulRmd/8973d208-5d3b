...
function App() {
  ...
  return (
    <div>
      <section className='grid grid-cols-12 sm:gap-10 gap-4'>
        {data?.map((vehicle, index) => (
          <div key={index} className='col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3'>
            <div className='bg-white rounded-lg p-4'>
              ...
              <p className='text-sm text-gray-500'>{vehicle.occupancy_status}</p>
              <p className='text-sm text-gray-500'>{vehicle.revenue_status}</p>
