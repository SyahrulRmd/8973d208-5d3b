  ...
  return (
    <div>
      <section className='container'>
        <h1 className='text-2xl font-bold mb-10'>Data Kendaraan</h1>
        ...
        <div className='flex flex-col justify-between items-center gap-4 mt-10'>
          <div className='flex justify-center gap-4'>
            <Button className='w-10 h-10 p-2! bg-white text-black border border-gray-300' onClick={handlePrevPage}>
              <ChevronLeft className='w-5 h-5' />
            </Button>
            <Button className='w-10 h-10 p-2! bg-white text-black border border-gray-300' onClick={handleNextPage}>
