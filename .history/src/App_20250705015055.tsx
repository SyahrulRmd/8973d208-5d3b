...
function App() {
  ...
  return (
    <div>
      <section className='container'>
        <div className='grid grid-cols-12 sm:gap-10 gap-4'>
          {data?.map((vehicle, index) => (
            <div key={index} onClick={() => setIsOpen(true)} className='col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3'>
      ...
      <CustomDialog isOpen={isOpen} setIsOpen={setIsOpen} title='Dialog' description='Dialog' trigger={<Button>Open</Button>}>
        <div>
          <h1>Dialog</h1>
        </div>
      </CustomDialog>
