      ...
      <section className='container'>
        ...
        <div className='flex flex-col justify-between items-center gap-4 mt-10'>
          <div className='flex justify-center gap-4'>
            <Button variant='outline' className='w-10 h-10 p-2!' onClick={handlePrevPage} disabled={!data?.links.prev}>
              <ChevronLeft className='w-5 h-5' />
            </Button>
            <Button variant='outline' className='w-10 h-10 p-2!' onClick={handleNextPage} disabled={!data?.links.next}>
