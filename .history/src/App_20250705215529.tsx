      ...
      <div onClick={() => setIsOpen(true)} >
        <div className='bg-white rounded-lg p-4 shadow-md space-y-3'>
          ...
          <div className='space-y-1'>
            <p className='text-sm text-gray-500'>Lattitude: {vehicle.latitude}</p>
            <p className='text-sm text-gray-500'>Longitude: {vehicle.longitude}</p>
          </div>
          <div>
            <p className='text-xs text-gray-500'>Terakhir Di-update</p>
            <p className='text-xs text-gray-500'>Per {formatDate(vehicle.updated_at)}</p>
          </div>
        </div>
      </div>
