      ...
      <div onClick={() => setIsOpen(true)} >
        <div className='bg-white rounded-lg p-4 shadow-md space-y-3'>
          ...
          <div className='space-y-1'>
            <p className='text-sm text-gray-500'><span className='font-medium'>Lattitude:</span> {vehicle.latitude}</p>
            <p className='text-sm text-gray-500'><span className='font-medium'>Longitude:</span> {vehicle.longitude}</p>
          </div>
          <div>
