...
const TripFilter = ({ selectedTrip, setSelectedTrip, selectedRoutes }: {
  ...
  const { data: trips, loadingAddition, refetchAddition, reset } = useGet<ListWrapper<TypeWrapper<Trip>[]>>(`${BASE_URL}/trips?${encodeURI(pageParams)}`, { isArray: true })
